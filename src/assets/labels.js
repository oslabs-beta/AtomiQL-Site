export default {
  header: {
    logo: "./src/assets/img/atomiql-logo.png",
  ...
  team: {
    ...
    members: [
      ...
      {
          photo: "./src/assets/img/paulo.png",
          name: "Paulo Choi",
          github: "@paulochoi",
          title: "Software Engineer",
      ...
      {
          photo: "./src/assets/img/thomas.png",
          name: "Thomas Harper",
          github: "@tommyrharper",
          title: "Software Engineer",
